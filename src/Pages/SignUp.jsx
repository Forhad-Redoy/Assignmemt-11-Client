...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await updateUserProfile(name, imageURL,address);
      console.log(result);
    ...
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900">
        ...
        <div
          ...
          className="flex justify-center items-center space-x-2 border m-3 p-2 border-gray-300 border-rounded cursor-pointer hover:scale-105 transition-transform duration-200"
        >
          <FcGoogle size={32} />
